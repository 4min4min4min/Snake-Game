...
class Snake:
    ...
    def update_head_graphics(self):
        if self.direction == Direction.RIGHT: self.head = self.head_right
        if self.direction == Direction.LEFT: self.head = self.head_left
        if self.direction == Direction.UP: self.head = self.head_up
        if self.direction == Direction.DOWN: self.head = self.head_down
        ...
        for index, part in enumerate(self.body):
                ...
                if index == 0:
                    ...
                    if next_part[0] == previous_part[0]:
                        ...
                        if next_part[0] == part[0] and previous_part[0] == part[0] + 40 and next_part[1] == part[1] - 40 and previous_part[1] == part[1] or next_part[0] == part[0] + 40 and previous_part[0] == part[0] and next_part[1] == part[1] and previous_part[1] == part[1] - 40:
                            screen.blit(self.body_tr,part_rect)
                        if next_part[0] == part[0] - 40 and previous_part[0] == part[0] and next_part[1] == part[1] and previous_part[1] == part[1] - 40 or next_part[0] == part[0] and previous_part[0] == part[0] - 40 and next_part[1] == part[1] - 40 and previous_part[1] == part[1]:
